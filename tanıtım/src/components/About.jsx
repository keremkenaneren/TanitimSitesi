                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 flex items-center justify-center lg:justify-start">
                    <div className="lg:flex">
                        <div className="lg:w-1/2 pr-6">
                            <img className="mx-auto lg:mx-0 rounded opacity-75 hover:opacity-100 transition" src={community} alt="community" />
                        </div>
                        <div className="lg:w-1/2">
                            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">About Us - Techs</h1>
