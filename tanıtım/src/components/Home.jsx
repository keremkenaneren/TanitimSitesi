                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                            ...
                            <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Contact Techs</h2>
                            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">If you want to learn more about the latest technology solutions or reach out to collaborate, we're here to assist you. Contact us today and let's walk into the future together.</p>
                            <Link to="/contact" href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                                <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                </svg>
                            </Link>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                            ...
                            <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Discover Our Cutting-Edge Solutions</h2>
                            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Explore our innovative range of technology solutions designed to meet your diverse needs. Dive into a world of possibilities and discover the future of tech.</p>
                            <Link to="/products" href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                                <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                </svg>
                            </Link>
